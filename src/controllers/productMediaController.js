...
exports.createProductMedia = async (req, res) => {
    try {
        const newProductMedia = await productMediaService.createProductMedia(req.body);
...
exports.updateProductMedia = async (req, res) => {
    try {
        const { id } = req.params;
        const updatedMedia = await productMediaService.updateProductMedia(id, req.body);
        res.status(200).json({
...
exports.deleteProductMedia = async (req, res) => {
    try {
        const deletedProductMedia = await productMediaService.deleteProductMedia(req.params.id);
