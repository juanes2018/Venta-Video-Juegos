...
exports.createStockMovement = async( req, res) => {
    try{
        const { inventory_item_id, from_location_id, to_location_id, type, quantity, notes } = req.body;
        ...
        const validTypes = ['sale','return','transfer','adjustment','purchase','damage','loss'];
