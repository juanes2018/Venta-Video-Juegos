...
exports.addProductToGuestCart = async (req, res) => {
    try {
        ...
        const result = await guestCartService.addProductToCart(guest_session_id, product_id, quantity);
        res.status(200).json({
...
exports.updateProductQuantityInGuestCart = async (req, res) => {
    try {
        ...
        await guestCartService.updateProductQuantity(guest_session_id, product_id, quantity);
