...
router.delete('/guest/:productId', guestCartController.removeProductFromGuestCart);
router.put('/guest/:productId', guestCartController.updateProductQuantityInGuestCart);
