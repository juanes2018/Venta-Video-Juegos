...
exports.addProductToCart = async (guest_session_id, product_id, quantity = 1) => {
...
// 1️⃣ Validar que el producto exista
    ...
    if (existing.length > 0) {
        ...
        await db.query(
            'UPDATE guest_carts SET quantity = ? WHERE id = ?',
...
exports.updateProductQuantity = async (guest_session_id, product_id, quantity) => {
    await db.query(
